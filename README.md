Simple TreeView built with Bootstrap and ASP.NET MVC. Project contains a database file with example data. It has adding, editing, removing, sorting and moving node features.</br>
